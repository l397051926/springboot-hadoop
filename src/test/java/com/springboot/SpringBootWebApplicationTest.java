...
import com.springboot.poi.dto.WebDto;
import com.springboot.poi.until.ExcelUtil;
...
public class SpringBootWebApplicationTest {
    ...
    public void test() throws Exception {
        ...
        ExcelUtil.getInstance().exportObj2ExcelByTemplate(map, "web-info-template.xls", new FileOutputStream("D:/out.xls"),
